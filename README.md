...
All entries come from **trusted Discord servers that track scammers**.

These servers:
- Are moderated
- Review reports carefully
- Confirm scams before adding them
...
- Only public Discord user IDs are listed
...
Running the bot, servers, and maintenance takes time and resources.
